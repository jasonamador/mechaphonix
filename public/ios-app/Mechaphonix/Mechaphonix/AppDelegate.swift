...
var messageRecived = Notification.Name("messageRecived")

extension AppDelegate: WCSessionDelegate {
    
    func session(_ session: WCSession, didReceiveMessage message: [String : Any]) {
        print("Message received: ",message)
        NotificationCenter.default.post(name: messageRecived, object: nil, userInfo: message)
//        socket.emit("pulse input", message)
    }
